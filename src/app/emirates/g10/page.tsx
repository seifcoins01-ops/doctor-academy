    ...
    <div dir={isArabic ? 'rtl' : 'ltr'} className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-sm text-gray-500 mb-6">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900 font-medium">{t.emirates.g10}</span>
        </div>
        ...
        <h1 className="text-3xl font-bold text-gray-900 text-center mb-4">{t.emirates.g10}</h1>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              ...
              <button onClick={() => openPayment(isArabic ? 'الحصة الأولى' : 'Lesson 1', 100, 'g10-l1')} className="bg-red-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-red-700 transition">
